...
const Experience: FC<Record<string, unknown>> = (): JSX.Element => {
  const { connectrnImg, i11Img, juristatImg, ussfImg, wwtImg } = useGetImages();
          ...
          <Card className="card">
            <CardContent className="card-content">
              <Row className="row">
                <ImgContainer className="col s12 m2">
                  ...
                  >
                    <GatsbyImage
                      ...
                      image={connectrnImg.childImageSharp.gatsbyImageData}
                      alt="ConnectRN Logo"
                    />
                  </a>
                </ImgContainer>
                ...
                <div className="role brown-text">Senior Software Engineer</div>
              </Row>
              <Divider className="divider" variant="middle" />
              <p className="subtitle">
                <em className="text-description">
                  ConnectRN is a trusted clinician-staffing partner that
                  delivers high quality nurses and CNAs at consistent rates, and
                  alleviates staffing shortages across healthcare settings.
                </em>
              </p>
              <h6>Product Development</h6>
              <ul>
                <li>
                  Full stack tech lead on scrum team designing and implementing
                  new product features
                </li>
                <li>
                  Designed, built, and deployed in-app payment system in React
                  Native and Golang. Allows app users to manage debit card and
                  financial transactions
                </li>
                <li>
                  Developed and deployed microservices in Golang using Docker
                  containers, Terraform, and AWS ECS
                </li>
                <li>
                  Participate in both frontend and backend guild meetings
                  discussing code quality, new trends, and general direction of
                  engineering department
                </li>
                <li>
                  Involved in candidate interviews and mentoring junior
                  developers
                </li>
                <li>
                  Tools: React, React Native, Typescript // Go, MySQL // AWS,
                  Terraform
                </li>
              </ul>
            </CardContent>
            <div className="card-footer">
              <span>June 2022 - Present | Chicago, IL</span>
            </div>
          </Card>
          <Card className="card">
            <CardContent className="card-content">
              ...
              <Divider className="divider" variant="middle" />
              <h6 className="subtitle">Product Development</h6>
              <ul>
                <li>
            ...
            <div className="card-footer">
              <span>March 2021 - May 2022 | Chicago, IL</span>
            </div>
          </Card>
          <Card className="card">
            <CardContent className="card-content">
